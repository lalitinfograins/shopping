          ...
          if (!input.password) {
            ...
            setPasswordError("Password must be one character")   
                ...
                const data = {
                 ...
                 axios.post('http://103.104.74.215:3003/website/update_user_data', data,options).then(res => {
                  ...
                  <div className="profile-contain">
                    <div className="profile-image">
                      <div className="position-relative">
                        <img src="../assets/images/inner-page/user/1.jpg" className="blur-up update_img lazyloaded" alt="" />
